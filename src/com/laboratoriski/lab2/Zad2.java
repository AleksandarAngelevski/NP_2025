...
public class Zad2 {
    ...
    static LocalDateTime localDateTimeOf() {
         ...
         */
        LocalDateTime ldt = LocalDateTime.of(2015,6,20,23,7,30);
        return ldt;
    }
    ...
    static LocalDateTime localDatePlusMinus() {
        ...
        return LocalDateTime.from(ldt).plus(Period.ofMonths(10)).minusHours(5);
    }
    ...
    static String toLocalDateTime() {
        ...
        LocalDateTime localDateTime2 = LocalDateTime.of(ld, lt);
