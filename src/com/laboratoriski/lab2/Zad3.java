...
public class Zad3 {
    ...
    static LocalTime localTimeWith() {
        ...
        return LocalTime.from(lt.with(ChronoField.HOUR_OF_DAY,21));
    }
    ...
    static LocalTime localTimePlus() {
         ...
         */
        return lt.plus(Duration.ofMinutes(30));
    }
    ...
    static LocalTime localTimeMinus() {
         ...
         */
        return LocalTime.from(lt.minus(Duration.ofHours(3)));
    }
    ...
    static LocalTime localTimeMinusDuration() {
         ...
         */
        return lt.minus(Duration.ofHours(3).plusMinutes(30).plusSeconds(20).plusNanos(2));
    }
