...
public class Zad3 {
    public static void main(String[] args) {
        ...
        Supplier<Doctor> supplier = () ->{
            ...
            int licenseNumber = Integer.parseInt(sc.next());
            String name =  sc.next();
            int level =  Integer.parseInt(sc.next());
            int numberOfPatients = Integer.parseInt(sc.next());
        ...
        System.out.println("\n=== All Doctors ===");
        Consumer<Doctor> printer = d-> System.out.println(d);
        er.forEach(printer);
        //TODO: Use Functional Interface to filter the good doctors ---
        DoctorEvaluator evaluator = new HighExpertiseEvaluator();
        Predicate<Doctor> patients = d -> d.getPatients() >20;
        Doctor[] passing = er.evaluate(d -> evaluator.evaluate(d) && patients.test(d));
